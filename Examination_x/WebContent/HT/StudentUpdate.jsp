        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5 ><%=request.getParameter("id") %>学生信息修改</h5>
                </div>
                <div class="ibox-content">
                    <form class="form-horizontal m-t" action="../StudentServlet?op=update&id=<%=request.getParameter("id") %>"  method="post">
                        <div class="row">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                              <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-6">
                                        <input class="form-control"  name="phone" placeholder="联系方式" type="text" value="">
                                    </div>
                                </div>
                                <div class="form-group">
